...
<div class="container">
	<div class="card my-3">
      ...
      <div class="card-body">	
        ...
        @endphp
        <div>
			<h5 class="font-weight-bold">Câu {{++$key}}: {{ $question->content }}<button type="button" class="btn btn-sm btn-primary ml-3" data-toggle="modal" data-target="#del_question{{$key}}">x</button>
