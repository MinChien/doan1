                        ...
                        <table class="container table-bordered">
                          <tbody>
                            ...
                            <tr>                              
                              ...
                              <td><a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#del_chapter{{$key}}-{{$key1}}">-</a>
                            ...
                            @endforeach
                            <tr>
                              <td colspan ="3"><a  href="#" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add_chapter{{$key}}">+</a></td>
