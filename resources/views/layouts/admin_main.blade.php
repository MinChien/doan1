    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow"><a href="#" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="fas fa-align-left"></i></a><a href="{{ route('admin.index') }}" class="navbar-brand font-weight-bold text-uppercase text-base">MultiChoice<span class="text-danger">.</span></a>
        <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
          ...
          <li class="nav-item dropdown ml-auto"><a id="userInfo" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><img src="/storage/avatar-admin/{{ empty(Auth::guard('admin')->user()->avatar) ? 'no_image.jpg' : Auth::guard('admin')->user()->avatar }}" style="max-width: 2.5rem;" class="img-fluid rounded-circle shadow"></a>
